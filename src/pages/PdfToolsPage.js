        ...
        <div className="pdf-tools-body">
            ...
            {pdf
                ...
                <div className="pdf-container">
                    ...
                    <Pagination currentPage={pdfData.currentPage} totalPages={pdfData.totalPages} decrementPage={() => setPdfData((previousState) => ({...previousState, currentPage: previousState.currentPage--}))} incrementPage={() => setPdfData((previousState) => ({...previousState, currentPage: previousState.currentPage++}))} />
                </div>
            }
